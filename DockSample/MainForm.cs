...
namespace DockSample
{
    public partial class MainForm : Form
    {
        ...
        private void SetSchema(object sender, System.EventArgs e)
        {
            ...
            string configFile = Path.Combine(Path.GetDirectoryName(Application.LocalUserAppDataPath), "DockPanel.temp.config");
        ...
        private void menuItemOpen_Click(object sender, System.EventArgs e)
        {
            ...
            openFile.InitialDirectory = Application.LocalUserAppDataPath;
        ...
        {
            string configFile = Path.Combine(Path.GetDirectoryName(Application.LocalUserAppDataPath), "DockPanel.config");
